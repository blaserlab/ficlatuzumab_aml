...
gene_name_list<-list(mod3genes)
list_name_list<-c("mod3")
...
new_agg_cds_mod3 <- new_agg_cds

mod3_monocle_regression <- lapply(
  X = seq_along(treatment_days),
  FUN = monocle_regression_func,
  cds = new_agg_cds_mod3,
  gene_or_genes = "mod3",
